...
class Cluster(object):
    ...
    syncs : dict, optional
        Mapper from Dimensions to expr-like, representing synchronization
        operations that must be performed before or after (this is inherent in
        the operation itself) computing the Cluster. The synchronization
        operations must be given in the order in which they are expected to
        be executed.
    """
